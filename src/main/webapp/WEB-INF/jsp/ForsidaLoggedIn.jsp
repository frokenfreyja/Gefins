        ...
        <%@ taglib prefix="sf" uri="http://www.springframework.org/tags/form" %>
            <%@ page contentType="text/html; charset=UTF-8" %>
                ...
                <head>
                    ...
                    <title>Forsida</title>
                    <link rel="stylesheet" type="text/css" href="<c:url value=" /css/forsidaloggedin.css "/>"/>
                            ...
                            <div class="row">
                                <div class="col col3-left">
                                    ...
                                    <%-- Leitargluggi sem leitar í auglýsingalista eftir leitarorðum--%>
                                        ...
                                        <%-- Takki sem hreinsar leitarniðurstöður og birtir upphaflegan auglýsingalista --%>
                                            <div class="clear">
                                            ...
                                            <div class="text">
                                                ...
                                                <%-- Checkbox tré sem birtir auglýsingar eftir póstnúmeri --%>
                                                    ...
                                                    <%-- Birtir á forsíðunni texta um hvaða póstnúmeri er leitað eftir  --%>
                                                        <div class="sortlist">
                                                            <c:choose>
                                                                <c:when test="${not empty zip}">
                                                        ...
                                                        <%-- Checkbox sem birtir auglýsingar á forsíðunni eftir flokkum  --%>
                                                            ...
                                                            <%-- Birtir á forsíðunni texta um hvaða flokki er leitað eftir  --%>
                                                                <div class="sortlist">
                                                                    <table class="lookfor">
                                                                        <c:choose>
                                                                                ...
                                                                                <td>
                                                                                    <c:choose>
                                                                                        ...
                                                                                        <c:when test="${loggedInUsername == skodaitem.acceptedUser}">
                                                                                                <a href="/skodaitemaccepted/${skodaitem.id}"><div class="notifyImg"><img src="${pageContext.request.contextPath}/resources/images/dot.png"/><div class="afterDot">${skodaitem.itemName}</div></div></a>
                                                                                        </c:when>
                                                                                        <c:otherwise>
